...
Формат: [CSV](https://data.mos.ru/opendata/7704221753-avtomaticheskie-stantsii-kontrolya-zagryazneniya-atmosfery "Паспорт набора данных портала открытых данных Правительства Москвы")
